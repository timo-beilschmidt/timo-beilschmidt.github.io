            ...
            <div class="row">
                <div class="col-xl-4 col-lg-5">
                    <div class="modern-service">
                        <h3 class="heading heading-h3 line-height-1-42 wow move-up">Kfz Gutachter Karakale -<br> Ihr Kfz Sachverständiger in Bonn</h3>
                    </div>
                </div>
                <div class="col-xl-7 offset-xl-1 col-lg-7 mt_md--30 mt_sm--30">
                    <div class="modern-service wow move-up">
                        ...
                        Falle der ungeklärten Schuldfrage nach einem Unfall mit Ihrem Kfz fertigen wir kostenlos eine Beweissicherung für Sie durch. Hierzu erstellen wir Lichtbilder von Ihrem Kfz und den unfallbedingten Beschädigungen, notieren uns sämtliche relevanten Daten zum Unfallgeschehen und speichern diese vorerst in unserem Rechnersystem ab.</p>
                    </div>
                </div>
            </div>
        </div>
