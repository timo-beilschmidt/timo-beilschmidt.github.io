<template>
    <div class="slider-area hero-business position-relative">
        ...
        <div class="squre-dots">
            <swiper :options="swiperOption">
                <div class="hero-item bg-image swiper-slide" :style="{ backgroundImage: `url('/img/slider/slide1.jpg')` }">
                        
                    <!-- Header Left start -->
                    <!-- <div class="header-right flex-20">
                        <div class="logo">
                            <n-link to="/">
                                <img src="/img/other/Logo_TUEV_NORD_Partner.jpg" alt="Brook Logo">
                            </n-link>
                        </div>
                    </div> -->
                    <!-- Header Left end -->
                ...
                <div class="hero-item bg-image swiper-slide" :style="{ backgroundImage: `url('/img/slider/slide2.jpg')` }">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="hero-content-2">
                ...
                <div class="hero-item bg-image swiper-slide" :style="{ backgroundImage: `url('/img/slider/slide3.jpg')` }">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="hero-content-2">
