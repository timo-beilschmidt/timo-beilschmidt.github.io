...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Kfz Gutachten Karakale","titleTemplate":"Kfz Gutachten Karakale || %s","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
